...
namespace Entity.Context
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<FormModule> FormsModules { get; set; }
        public DbSet<RoleFormPermission> RoleFormPermissioSet { get; set; }
        ...
        /// <summary>
        /// Ejecuta una consulta SQL de tipo comando y devuelve el número de filas afectadas.
        /// </summary>
        ...
        /// <summary>
        /// Ejecuta una consulta SQL y devuelve un solo valor del tipo especificado.
        /// </summary>
