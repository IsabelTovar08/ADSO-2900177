...
using Module = Entity.Models.Module;
...
namespace Entity.Context
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, IConfiguration configuration, AuditManager auditManager)
        : base(options)
        {
        ...
        //PublicApi 
        DbSet<UserPublic> UsersPublic { get; set; }
        DbSet<AlbumsPublic> AlbumsPublic { get; set; }
        ...
        {
            //EnsureAudit();
            await _auditManager.ProcessAuditLogsAsync(ChangeTracker);
