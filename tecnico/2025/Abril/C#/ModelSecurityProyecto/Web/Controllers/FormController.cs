...
namespace Web.Controllers
{
    ...
    {
        private readonly FormBusiness2 _FormBusiness;
        private readonly ILogger<FormController> _logger;

        /// <summary>
        /// Constructor del controlador de formularios
        /// </summary>
        public FormController(FormBusiness2 formBusiness, ILogger<FormController> logger)
        {
        ...
        public async Task<IActionResult> HardDeleteForm(int id)
        {
            try
            {
                var deleted = await _FormBusiness.HardDeleteFormAsync(id);
                if (!deleted)
