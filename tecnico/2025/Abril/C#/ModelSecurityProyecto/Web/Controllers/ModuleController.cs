...
namespace Web.Controllers
{
    ...
    public class ModuleController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetModuleById(int id)
        {
            try
            {
                var modulee = await _ModuleBusiness.GetModuleByIdAsync(id);
                return Ok(modulee);
            }
        ...
        public async Task<IActionResult> SoftDeleteModule(int id)
        {
            try
            {
                var deleted = await _ModuleBusiness.SoftDeleteModuleAsync(id);
                if (!deleted)
        ...
        public async Task<IActionResult> HardDeleteModule(int id)
        {
            try
            {
                var deleted = await _ModuleBusiness.HardDeleteModuleAsync(id);
                if (!deleted)
