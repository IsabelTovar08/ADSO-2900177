...
CREATE TABLE [RolFormPermission] (
    ...
    CONSTRAINT [FK_Form_Rfp] FOREIGN KEY ([FormId]) REFERENCES [Form]([Id]),
    CONSTRAINT [FK_Rol_Rfp] FOREIGN KEY ([RolId]) REFERENCES [Rol]([Id]),
    CONSTRAINT [FK_Permision_Rfp] FOREIGN KEY ([PermissionId]) REFERENCES [Permission]([Id])
);
