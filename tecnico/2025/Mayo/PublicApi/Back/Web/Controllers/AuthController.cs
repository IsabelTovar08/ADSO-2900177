...
namespace Web.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(JwtService jwtService, AuthService userBusiness, UserRolBusiness userRolBusiness)
        {
        ...
        public async Task<IActionResult> GoogleLogin([FromBody] TokenDto tokenDto)
        {
            ...
            var user = await _authService.GetOrCreateGoogleUser(userInfo);
        ...
        public async Task<IActionResult> LoginWithGoogleCode([FromBody] GoogleCodeDTO code)
        {
            var user = await _authService.AuthenticateWithGoogleCodeAsync(code);
            if (user == null) return Unauthorized("Código inválido o expirado");
